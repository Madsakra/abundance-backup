...
export default function MetabolicTask() {
  ...
  const metValue = parseFloat(
    Array.isArray(params.value) ? params.value[0] : params.value || "0"
  );
    ...
    <ScrollView style={{ flex: 1}}>
      ...
      <View style={styles.calculatorBox}>
        ...
        <View style={[styles.valueBar,{paddingVertical:30,borderRadius:10,marginTop:20}]}>
          ...
          <View>
          <Text style={{color:"white",fontSize:18,marginVertical:5}}>Calories Output</Text>
          <Text style={{color:"white",fontSize:25,fontWeight:"bold"}}>{caloriesBurnt.toFixed(2)}  k/cal</Text>
          </View>
