...
import {
  ...
  NutritionistAccount,
  nutritionistProfile,
} from '~/types/common/nutritionists';
    ...
    <ScrollView>
      {loading ? (
        ...
        <View style={styles.profileContainer}>
          ...
          <Text
            style={{ marginVertical: 20, marginBottom: 5, fontSize: 17, fontWeight: 'semibold' }}>
            Specializes in:
          </Text>
          <View
            style={{
          ...
          <Text
            style={{ alignSelf: 'flex-start', marginBottom: 18, fontSize: 17, fontWeight: 'bold' }}>
            All Reviews
          </Text>
          ...
          {displayReviews?.map((rev, index) => (
            <View
              ...
              key={index}>
              <View
                style={{ flexDirection: 'row', gap: 20, borderRadius: 10, alignItems: 'center' }}>
