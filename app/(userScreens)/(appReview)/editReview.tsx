 ...
 export default function editReview() {
  ...
  const fetchData = async()=>{
    ...
    if (userReviewSnap.exists) {
      ...
      if (matchedReview) {
        setSelectedReview(matchedReview); // Set review from fetched data
        setSelectedReasons(reviewData.reasons); // Set selected reasons
      }}
  ...
  useEffect(()=>{
   ...
   return (
    <ScrollView style={{padding:10}}>
      ...
      <Text style={styles.ratingHeader}>Edit Review</Text>
